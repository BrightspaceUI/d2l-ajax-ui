...
"use strict";var jwt=require("frau-jwt/framed");Polymer({is:"d2l-ajax-framed",properties:{auto:Boolean,url:String,params:{type:Object,value:function(){return{}}},method:{type:String,value:"GET"},headers:{type:Object,value:function(){return{}}},contentType:String,body:Object,handleAs:String,withCredentials:Boolean,timeout:Number,lastResponse:{type:Object,notify:!0},lastError:{type:Object,notify:!0},scope:{type:String,value:"*:*:*"},authToken:{type:String,value:function(){return null}}},observers:["_requestOptionsChanged(url, params.*, body)"],computeHeaders:function(e,t){var n,r={};if(t&&(r.Authorization="Bearer "+t),e instanceof Object)for(n in e)r[n]=e[n].toString();return r},generateRequest:function(){jwt(this.scope).then(function(e){this.authToken=e,this.$$("iron-ajax").generateRequest()}.bind(this)).catch(function(e){this.onError(e)}.bind(this))},onError:function(e){var t=e;e&&e.detail&&(t=e.detail),this.fire("iron-ajax-error",t)},onRequest:function(e){this.fire("iron-ajax-request",e.detail)},onResponse:function(e){this.fire("iron-ajax-response",e.detail)},_requestOptionsChanged:function(){null!=this.url&&this.auto&&this.generateRequest()}});
},{"frau-jwt/framed":2}],2:[function(require,module,exports){
"use strict";module.exports=require("./src/framed");
},{"./src/framed":15}],3:[function(require,module,exports){
"use strict";module.exports=require("./src/client");
},{"./src/client":4}],4:[function(require,module,exports){
...
},{"./plugins/iframe-resizer/client":5,"./plugins/sync-font/client":6,"./plugins/sync-lang/client":7,"./plugins/sync-title/client":8,"./port":10,"inherits":19,"lie":20}],5:[function(require,module,exports){
...
},{"iframe-resizer/js/iframeResizer.contentWindow":17}],6:[function(require,module,exports){
...
},{"./validate-event":14,"uuid":22}],10:[function(require,module,exports){
"use strict";module.exports=require("./services");

},{"./services":12}],11:[function(require,module,exports){
...
},{"./base":9,"./transform-error":13,"inherits":19,"lie":20}],12:[function(require,module,exports){
...
},{"./requests":11,"inherits":19}],13:[function(require,module,exports){
...
},{"./request-key":16,"ifrau/client":3,"lie":20}],16:[function(require,module,exports){
