...
"use strict";function Client(e){if(!(this instanceof Client))return new Client(e);e=e||{},Port.call(this,window.parent,"*",e),e.syncLang&&this.use(syncLang),e.syncTitle!==!1&&this.use(syncTitle),e.syncFont&&this.use(syncFont),e.resizeFrame!==!1&&this.use(resizer)}var inherits=require("inherits"),Promise=require("lie"),Port=require("./port"),resizer=require("./plugins/iframe-resizer/client"),syncLang=require("./plugins/sync-lang/client"),syncTitle=require("./plugins/sync-title/client"),syncFont=require("./plugins/sync-font/client");inherits(Client,Port),Client.prototype.connect=function(){var e=this;return new Promise(function(n){e.open(),e._sendMessage("evt","ready"),Port.prototype.connect.call(e),n(e)})},module.exports=Client;
