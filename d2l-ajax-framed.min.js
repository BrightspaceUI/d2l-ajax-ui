...
"use strict";var jwt=require("frau-jwt/framed");Polymer({is:"d2l-ajax-framed",properties:{auto:Boolean,url:{type:Object,value:null},params:{type:Object,value:function(){return{}}},method:{type:String,value:"GET"},headers:{type:Object,value:function(){return{}}},contentType:String,body:{type:Object,value:null},handleAs:String,withCredentials:Boolean,timeout:Number,lastResponse:{type:Object,notify:!0},lastError:{type:Object,notify:!0},scope:{type:String,value:"*:*:*"},authToken:{type:String,value:function(){return null}},debounceDuration:{type:Number,value:0,notify:!0}},observers:["_requestOptionsChanged(url, params.*, body, auto)"],computeHeaders:function(e,t){var n,r={};if(t&&(r.Authorization="Bearer "+t),e instanceof Object)for(n in e)r[n]=e[n].toString();return r},generateRequest:function(){return jwt(this.scope).then(function(e){return this.authToken=e,this.$$("iron-ajax").generateRequest().completes}.bind(this)).catch(this.onError.bind(this))},onError:function(e){e.stopPropagation&&e.stopPropagation();var t=e;e&&e.detail&&(t=e.detail),this.fire("iron-ajax-error",t)},onRequest:function(e){e.stopPropagation(),this.fire("iron-ajax-request",e.detail)},onResponse:function(e){e.stopPropagation(),this.fire("iron-ajax-response",e.detail)},_requestOptionsChanged:function(){null!=this.url&&this.auto&&this.generateRequest()}});
