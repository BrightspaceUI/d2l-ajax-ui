...
"use strict";var jwt=require("frau-jwt/framed");Polymer({is:"d2l-ajax-framed",properties:{auto:{type:Boolean,value:!1},url:{type:String},params:{type:Object,value:function(){return{}}},method:{type:String,value:"GET"},headers:{type:Object,value:function(){return{}}},contentType:{type:String,value:null},body:{type:Object,value:null},handleAs:{type:String,value:"json"},withCredentials:{type:Boolean,value:!1},timeout:{type:Number,value:0},lastResponse:{type:Object,notify:!0},lastError:{type:Object,notify:!0},scope:{type:String,value:"*:*:*"},authToken:{type:String,value:function(){return null}}},observers:["_requestOptionsChanged(url, method, params.*, headers, contentType, body, handleAs, withCredentials, timeout, auto)"],computeHeaders:function(e,t){var n,r={};if(t&&(r.Authorization="Bearer "+t),e instanceof Object)for(n in e)r[n]=e[n].toString();return r},generateRequest:function(){jwt(this.scope).then(function(e){this.authToken=e,this.$.request.generateRequest()}.bind(this)).catch(function(e){this.onError(e)}.bind(this))},onError:function(e){var t=e;e&&e.detail&&(t=e.detail),this.fire("iron-ajax-error",t)},onRequest:function(e){this.fire("iron-ajax-request",e.detail)},onResponse:function(e){this.fire("iron-ajax-response",e.detail)},_requestOptionsChanged:function(){null!=this.url&&this.auto&&this.generateRequest()}});
},{"frau-jwt/framed":2}],2:[function(require,module,exports){
"use strict";module.exports=require("./src/framed");
},{"./src/framed":3}],3:[function(require,module,exports){
...
},{"./request-key":4,"ifrau/client":6,"lie":20}],4:[function(require,module,exports){
...
},{"./src/client":7}],7:[function(require,module,exports){
...
},{"./plugins/iframe-resizer/client":8,"./plugins/sync-font/client":9,"./plugins/sync-lang/client":10,"./plugins/sync-title/client":11,"./port":13,"inherits":19,"lie":20}],8:[function(require,module,exports){
...
},{"iframe-resizer/js/iframeResizer.contentWindow":5}],9:[function(require,module,exports){
...
},{"./validate-event":17,"uuid":22}],13:[function(require,module,exports){
"use strict";module.exports=require("./services");

},{"./services":15}],14:[function(require,module,exports){
...
},{"./base":12,"./transform-error":16,"inherits":19,"lie":20}],15:[function(require,module,exports){
...
},{"./requests":14,"inherits":19}],16:[function(require,module,exports){
